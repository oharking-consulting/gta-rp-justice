module.exports = async (req, res) => {
    ...
    try {
        ...
        // Mode secours local robuste et structuré
        ...
        // Tentative d'utilisation de Gemini si la clé est valide et fonctionnelle
        ...
        if (apiKey) {
            try {
                ...
                // Ignore l'erreur de l'IA et bascule directement sur le secours local
            }
        }
        ...
        // En cas d'erreur critique, on renvoie une réponse propre au front-end pour éviter tout crash
        const safeFallback = {
            titre: "Incident RP",
